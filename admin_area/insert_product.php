...
<label class="col-md-3 control-label" > 1ª Imagem do Produto </label>
...
<label class="col-md-3 control-label" > 2ª Imagem do Produto</label>
...
<label class="col-md-3 control-label" > Quantidade do Produto </label>
...
<label class="col-md-3 control-label" > Chaves de Pesquisa </label>
