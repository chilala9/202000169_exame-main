...
<i class="fa fa-dashboard" ></i> Painel / Inserer Usuário
...
<i class="fa fa-money fa-fw" ></i> Inserer Usuário
...
<label class="col-md-3 control-label">Emprego: </label>
...
<label class="col-md-3 control-label">Informações adicionais: </label>
