...
<a href="forgot_pass.php">Esqueceu a senha?</a>        
    
</h5>

<a href="customer_register.php" >

<h5>Novo? Criar Conta</h5>
...
if($decrypt_password==0){
    ...
    echo "<script>alert('Sua senha ou e-mail está errado')</script>";
    exit();
}
...
echo "<script>window.open('checkout.php','_self')</script>";
    ...
    echo "<script>alert('Todos os campos são necessários')</script>";
    echo "<script>window.open('checkout.php','_self')</script>";
}
