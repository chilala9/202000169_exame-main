...
<div class="container">
    <div class="row text-center">
        <div class="col-sm-6 card box-status"  style="background-color: lightblue ;">
            <h2>Aceites</h2>
            <h1>
                <?php 
                    $sql = "SELECT * FROM `pending_orders` WHERE `order_status` = 'aceite'";
                    $query = mysqli_query($db, $sql);
                    echo mysqli_num_rows($query);
                ?>
            </h1>
        </div>
        <div class="col-sm-6 card box-status" style="background-color: red ;">
            <h2>Rejeitados</h2>
            <h1>
                <?php 
                    $sql = "SELECT * FROM `pending_orders` WHERE `order_status` = 'rejeitado'";
                    $query = mysqli_query($db, $sql);
                    echo mysqli_num_rows($query);
                ?>
            </h1>
...
<h3><a href="#">Amamos os nossos clientes </a></h3>

<p>
Somos conhecidos por fornecer o melhor serviço possível de todos os tempos
</p>
...
Você pode verificar em todos os outros sites os preços e comparar conosco.
...
Devoluções gratuitas em tudo durante 3 meses
...
<h2>MAIS RECENTE ESTA SEMANA</h2>
